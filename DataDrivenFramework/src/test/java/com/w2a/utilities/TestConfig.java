...
public class TestConfig{
	...
	public static String from = "sheeridtestbedbath@gmail.com";
	public static String password = "Test@111";
	public static String[] to ={"deepaksh08@yahoo.com","deepaksh088@gmail.com"};
